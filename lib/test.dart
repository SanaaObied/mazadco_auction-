...
class _NewProductScreenState extends State<NewProductScreen> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.info_outline, size: 16, color: const Color(0xFF0D47A1)),
  ...
  Widget _buildImagePreview() {
    ...
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Icon(Icons.add_a_photo, size: 50, color: const Color(0xFF1976D2).withOpacity(0.5)),
        const SizedBox(height: 10),
        Text(
  ...
  Widget _buildDatePickerField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: const Icon(Icons.arrow_drop_down, color: Color(0xFF1976D2)),
        contentPadding: const EdgeInsets.symmetric(vertical: 16, horizontal: 20),
      ),
  ...
  Widget _buildCategoryDropdown() {
    return DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: Colors.white,
        prefixIcon: const Icon(Icons.category, color: Color(0xFF1976D2)),
  ...
  Future<void> _submitForm() async {
    ...
    setState(() => _isSubmitting = true);
     ...
     try {
      const serverUrl = 'http://localhost/auction/add-product.php';
