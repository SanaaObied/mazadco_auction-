...
df = pd.read_csv('./balanced_user_behavior.csv')  # Replace with your actual filename

# Step 2: Encode the target labels
le = LabelEncoder()
df['risk_level'] = le.fit_transform(df['risk_level'])  # Low=1, Medium=2, High=0 (example mapping)
